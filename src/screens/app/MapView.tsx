    ...
    <div className="relative h-full w-full bg-[#0b1220]">
      ...
      <MapContainer
        ...
        style={{
          ...
          right: 0,
          top: 0,
          bottom: 96, // Alt bar yüksekliği kadar boşluk bırak
          width: '100%',
          height: 'auto',
          minHeight: 400,
          borderRadius: 0,
        ...
        <div className="absolute bottom-0 left-0 w-full z-50">
          <div className="mx-auto max-w-3xl bg-[#0B0F17] border-t border-[#07B1FF]/30 rounded-t-3xl p-6 pb-28 shadow-2xl relative">
            ...
            <div className="flex gap-3 mt-4">
              <button onClick={() => { setMode('nav'); }} className="flex-1 py-3 rounded-xl bg-gray-800 text-white font-bold border border-white/6">Rota Çiz</button>
